	...
	<body data-spy="scroll" data-target="#consolelist" data-offset="55">
      ...
      <div class="navbar navbar-dark bg-dark box-shadow fixed-top">
		...
		<footer class="text-muted">
			<div class="container">
				<p><small>Video Game Collection database generated by <a href="#"><em>aboutcher-vgc <?php echo $version; ?></em></a> by <a href="https://www.aboutcher.co.uk">Adam Boutcher</a>.</small></p>
			</div>
		</footer>
